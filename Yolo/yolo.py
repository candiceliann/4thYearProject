...
def args():
    ...
    ap.add_argument("-y", "--yolo_weights", required=True,
...
def yolo(args):
    ...
    labelsPath = os.path.sep.join([args["yolo_weights"], "coco.names"])
    ...
    weightsPath = os.path.sep.join([args["yolo_weights"], "yolov3.weights"])
    configPath = os.path.sep.join([args["yolo_weights"], "yolov3.cfg"])
